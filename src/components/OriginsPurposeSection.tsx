  ...
  return (
    <section className="py-16 md:py-24 bg-background text-foreground border-t border-gray-200 dark:border-gray-800">
      <div className="container max-w-4xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative w-full h-72 rounded-lg overflow-hidden group cursor-pointer" onClick={() => setIsDialogOpen(true)}>
            <img
              src="https://picsum.photos/seed/eder-origins/800/600"
              alt="Origens e Propósito"
      ...
      <DetailDialog
        ...
        title={t('origins_purpose.title')}
        imageSrc="https://picsum.photos/seed/eder-origins/1200/800"
      >
        <p>{t('origins_purpose.paragraph1')}</p>
        <p>{t('origins_purpose.paragraph2')}</p>
      </DetailDialog>
