...
export default function Impacto(){
  return <main className="inner-page">
    <section className="page-hero impact-hero"><span>04 — Social</span><h1>Missão NASCE<br/>e projetos apoiados.</h1><p>A Gaio apoia projetos de educação, formação e cuidado da Missão NASCE no Brasil e em Moçambique.</p></section>
    <section className="impact-feature"><img src="/images/nasce/nasce-hero.png" alt="Missão NASCE"/><div><span>Sobre o apoio</span><h2>Uma parceria ligada à fé e ao serviço.</h2><p>A Gaio destina parte de seus lucros a atividades da Missão NASCE voltadas a famílias e crianças em situação de vulnerabilidade.</p><a href="https://mnasce.com/" target="_blank" rel="noreferrer">Site da Missão NASCE ↗</a></div></section>
